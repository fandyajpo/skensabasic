...
import { LinkSVG } from "../../lib/listSvg";
          ...
          <ScrollView>
            <View style={tw`h-full w-full bg-white p-2 `}>
              ...
              >
                <View>
                  <View>
                    <Text style={tw`font-semibold text-sm text-gray-500`}>
                      Tugas
                    </Text>
                    <View style={tw`flex flex-row w-full overflow-hidden`}>
                      <View style={tw` p-2`}>
                        <Text
                          style={tw`text-xs text-blue-600 py-0.5 font-bold`}
                        >
                          Mata Pelajaran
                        </Text>
                        <Text
                      ...
                      <View style={tw`w-3/4`}>
                        ...
                        >
                          <Text
                            style={tw`text-xs text-gray-600 py-0.5 font-bold`}
                          >
                    ...
                    <View style={tw`flex items-end justify-end pt-4 `}>
                      <TouchableOpacity
                        style={tw`flex flex-row items-center bg-blue-500 rounded-full px-5 py-2`}
                      >
